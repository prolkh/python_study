...
btn_f16.grid(row=0, column=0, sticky=N+E+W+S , padx=3, pady=3) # N+E+W+S (각각 위, 오, 왼, 아래의 그리드 채우기를 의미함)
btn_f17.grid(row=0, column=1, sticky=N+E+W+S , padx=3, pady=3) # padx(좌, 우 그리드 내 padding 설정), pady(위, 아래 padding)
